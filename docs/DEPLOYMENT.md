...
5. 独立公告后台入口为 `https://cele-student-handbook-2026.vercel.app/admin/login`；该地址不在公开导航中。
...
- 如使用 `NEXT_PUBLIC_SITE_URL`，将其设置为 `https://cele-student-handbook-2026.vercel.app`。
